...
<div class="content-wrapper">
    <div class="create-board">
        <div class="board-header">Edit Produk</div>
        ...
        <div class="board-body">
            <div class="upload-panel">
                <div class="upload-preview-box">
                    ...
                    <img src="{{ asset('storage/' . $produk->gambar) }}" class="old-img" id="oldPreview" alt="Gambar Produk Saat Ini">
                    <img id="preview" alt="Preview Gambar Baru">
                </div>
                ...
                <p class="upload-note">Upload gambar baru hanya jika ingin mengganti cover produk.</p>
            </div>
            ...
            <div class="form-panel">
                ...
                <form id="produkForm" action="{{ route('admin.produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()" class="product-form">
                    @csrf
                    @method('PUT')

                    <div class="field-group">
                        <label for="nama">Judul</label>
                        <input class="form-input input-lg" type="text" name="nama" id="nama" value="{{ old('nama', $produk->nama) }}">
                    </div>

                    <div class="field-group">
                        <label for="penulis">Penulis</label>
                        <input class="form-input input-lg" type="text" name="penulis" id="penulis" value="{{ old('penulis', $produk->penulis) }}">
                    </div>

                    <div class="field-group">
                        <label for="harga">Harga</label>
                        <input class="form-input input-md" type="number" name="harga" id="harga" value="{{ old('harga', $produk->harga) }}">
                    </div>

                    <div class="field-group">
                        <label for="stok">Stok</label>
                        <input class="form-input input-sm" type="number" name="stok" id="stok" value="{{ old('stok', $produk->stok) }}">
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        <textarea class="form-textarea" name="deskripsi" id="deskripsi">{{ old('deskripsi', $produk->deskripsi) }}</textarea>
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        <input class="form-input input-md" type="date" name="tanggal_terbit" id="tanggal_terbit" value="{{ old('tanggal_terbit', $produk->tanggal_terbit) }}">
                    </div>

                    <div class="field-group">
                        <label for="bahasa">Bahasa</label>
                        <input class="form-input input-sm" type="text" name="bahasa" id="bahasa" value="{{ old('bahasa', $produk->bahasa) }}">
                    </div>

                    <div class="field-group">
                        <label for="jumlah_halaman">Halaman</label>
                        <input class="form-input input-sm" type="number" name="jumlah_halaman" id="jumlah_halaman" value="{{ old('jumlah_halaman', $produk->jumlah_halaman) }}">
                    </div>
...
function validateForm() {
    const inputs = [
        ...
        document.getElementById('tanggal_terbit'),
        document.getElementById('bahasa'),
        document.getElementById('jumlah_halaman')
    ];
