...
<html>
<head>
    <title>Dashboard Staff - BookHaven</title>
...
<div class="section">
    ...
    <div class="section-header">
        ...
        <a href="{{ route('staff.kategori', $kat->id) }}" class="lihat-semua">Lihat Semua</a>
    </div>

    <div class="book-grid">
        @foreach($kat->produk as $item)
        <a href="{{ route('staff.produk.detail', $item->id) }}" class="book-link">
