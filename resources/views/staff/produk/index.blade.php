...
<html>
<head>
    <title>Manajemen Produk - BookHaven</title>
...
<div class="content-wrapper">
    ...
    <div class="top-bar">
        ...
        <a href="{{ route('staff.produk.create') }}">
    ...
    <div class="card">
        ...
        <div class="info">
            ...
            <div class="actions">
                <a href="{{ route('staff.produk.edit', $item->id) }}">
                    <button class="produk-action-btn">Edit</button>
                </a>

                <form action="{{ route('staff.produk.destroy', $item->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
